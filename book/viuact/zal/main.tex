...
Wymaganie WF-01 czyli ,,Zachowanie znaczenia programu podczas kompilacji'' jest
trudne do spełnienia, ponieważ nie jesteśmy w stanie przetestować wszystkich
programów możliwych do napisania w języku \ViuAct. Z tego powodu, między innymi,
testy kompilatora języka \ViuAct\ zostały wykonane jako testy pojedynczych
konstrukcji językowych -- np. konstrukcji warunkowych i wyrażeń złożonych.
...
\begin{tabular}{ | l | l | }
    \hline
    \textbf{Identyfikator} & \parbox[t]{11cm}{PW-02} \\
    \hline
    \textbf{Priorytet} & S \\
    \hline
    ...
    \textbf{Opis} & \parbox[t]{11cm}{
        ...
        ich kombinacji. Z uwagi na to, że jest niemożliwym przetestowanie kompilatora na wszystkich
