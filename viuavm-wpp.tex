...
Jakość będzie zapewniona poprzez testowanie automatyczne, sporządzanie specyfikacji i dokumentacji, oraz
dzięki wsparciu narzędzi; np. instrumentacji programów przez kompilator i sanitisery, użycie walidatorów (np.
Valgrind).
...
Komunikacja w zespole odbywa się poprzez kanał IRC, email, oraz na spotkaniach.
